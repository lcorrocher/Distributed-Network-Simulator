        ...
        try {
            ...
            for (String[] line : lines) {
                ...
                for (String entry : entries) {
                    ...
                    String edgeRouterId = col[0];
                    String fileName = edgeRouterId + ".txt";
                    ...
                    // Read the file for this edge router ID
                    List<String[]> arpLines = FileUtils.readFile(fileName);
                    int id = 1;
                    ...
                    localEndHostTables.put(edgeRouterId, endHostTable);
                }
            }
